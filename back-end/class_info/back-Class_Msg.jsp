...
<%
	...
	Map<Main_messageVO, List<Sub_messageVO>> getMessageClass = AllClass_infoVO.getMessageClass();
	Set<Main_messageVO> MessageClassKeys = (Set<Main_messageVO>)getMessageClass.keySet();
	Class_infoVO class_info = (Class_infoVO)AllClass_infoVO.getClass_infoVO();
	pageContext.setAttribute("class_info", class_info);
	pageContext.setAttribute("getMessageClass", getMessageClass);
	...
	<div style="margin-left: 250px; margin-right: 20px; margin-top: 50px" >
		<nav aria-label="breadcrumb" style="margin-top: 30px;">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">課程留言</li>
			</ol>
		</nav>
		<br>
		<div class="container">
			<h1>課程頁面留言</h1>
			<c:if test="${empty getMessageClass}">
							...
							<div id="collapse_${loop.index}" class="collapse"
								...
								<div class="card-body" style="padding: 0%;">
									<table class="table table-striped">
										...
										<!--迴圈取出所有物件 -->
										<c:forEach var="sub_messageVO" items="${getMessageClass[MessageClassKey]}" >
