...
<%
	...
	List<Class_infoVO> list = ciSvc.getAllVerifyStatus4();
            ...
            <div class="container" style="text-align:center">
                ...
                <h1>課程列表</h1>
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/back-end/verify_list/back-verify_lis0.jsp">待審核</a></li>
                        ...
                        <li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/back-end/verify_list/back-verify_list7.jsp">未送審</a></li>
                    </ul>
                </nav>
            </div>
        </div>
