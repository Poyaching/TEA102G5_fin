...
<body bgcolor='white'>
	...
	<div>
		...
		<form action="<%=request.getContextPath()%>/Video_record/Video_recordServlet" method="POST">
			<h2>查詢單筆資料</h2>
			<Label for="record_id">影片紀錄編號</Label>
			<input name="record_id" type="text" placeholder="輸入影片紀錄編號" >
			<br>
			<Label for="member_id">會員編號</Label>
			<input name="member_id" type="text" placeholder="輸入會員編號" >
			<br>
<!--    			要改為ajex 動態選擇		 -->
			...
			<input name="unit_id" type="text" placeholder="輸入單元編號" >
			<br>
