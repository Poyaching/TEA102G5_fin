...
<%
	...
	List<Video_recordVO> list = video_recordService.getAll();
...
<title>所有使用者觀看紀錄 - listAll.jsp</title>
</head>
		...
		<table class="table table-striped">
			...
			<c:forEach var="Video_recordVO" items="${list}"
				...
				<tr>
					...
					<!-- 瀏覽紀錄更新時間-->
					<td><fmt:formatDate value="${Video_recordVO.video_updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
