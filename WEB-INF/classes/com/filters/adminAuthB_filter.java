...
public class adminAuthB_filter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		Admin_authVO Auth_listA = (Admin_authVO) list.get(1);
//		System.out.println(Auth_listA.getAuth_status());
		if(Auth_listA.getAuth_status() == 1) {
//			System.out.println("Auth_listA == 1");
