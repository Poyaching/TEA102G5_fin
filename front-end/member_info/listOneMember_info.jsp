						...
						<div class="col-12 row">
							<div class="col-6">
								<label for="f_date1">註冊時間</label> <input name="register_time"
									id="f_date1" type="text" class="form-control" 
									value="<%=member_infoVO.getRegister_time()%>" disabled>

							</div>
							<div class="col-6">
								<label>資料更新時間</label> <input name="member_update"
									id="f_date3" type="text" class="form-control" value="<%=member_infoVO.getMember_update()%>" disabled>
