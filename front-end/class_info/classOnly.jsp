				...
				<div class="row">
					...
					<div class="col-3 video-list">
						<div class="alert shadow text-white" role="alert"
							...
							<h5>
								<b style="color: rgb(255, 102, 102);">募資倒數中</b>
							</h5>
						</div>
						<div
							...
							<div
								...
								<div style="margin: 10px; text-align: center;">
									<div class="alert  shadow text-white" role="alert"
										style="margin: 10px; background-color: tomato; border-radius: 25px;">
										<b style="color: white;">募資剩餘時間</b>
									</div>
									<h5 id="day" style="display: inline;"></h5>
									<h6 style="display: inline;">
										<b>天</b>
									</h6>
									<h5 id="hour" style="display: inline;">
										<b></b>
									</h5>
									<h6 style="display: inline;">
										<b>時</b>
									</h6>
									<h5 id="min" style="display: inline;"></h5>
									<h6 style="display: inline;">
										<b>分</b>
									</h6>
									<h5 id="sec" style="display: inline;">
										<b></b>
									</h5>
									<h6 style="display: inline;">
										<b>秒</b>
									...
									<div style="margin-top: 5px;">
										<div class="class-sell">
											...
											<h4 style="margin: 0px; text-decoration: line-through;">
			...
			<div id="tab-demo">
				...
				<div id="tab01" class="tab-inner " style="margin-bottom: 150px">
					...
					<div id="tab04" class="tab-inner" style="margin-bottom: 150px">
						<div class="text-center">
							<a href="<%=request.getContextPath()%>/front-end/sign_in/sign_in.jsp">購買後才可評價</a>
						</div>
