	...
	<div class="container">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1>會員資料</h1>
				<h4>
<%-- 					<a href="<%=request.getContextPath()%>/back-end/member_info/select_page.jsp">查詢會員資料</a> --%>
				</h4>
			</div>
		</div>
		...
		<div id="content">
			<FORM class="g-3" METHOD="post"
				ACTION="<%=request.getContextPath()%>/member_info/Member_info_frontServlet"
				name="form1" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-2 col-sm-4 col-12">
						<div id="preview">
							<span class="text"><img id="output_image"
								src="<%=request.getContextPath()%>/member_info/Member_info_frontServlet?action=member_pic&member_id=${member_infoVO.member_id}"></span>
						</div>
					...
					<div class="col-lg-10 col-sm-8 col-12">
						...
						<div class="col-12 row">
							...
							<div class="col-6">
								<label for="goodfor">專長</label> <input type="text" id="goodfor"
									...
									value="<%=member_infoVO.getMember_good_for()%>" disabled>
							</div>
							<div class="col-6">
								<label for="about">關於我</label>
								<textarea id="about" class="form-control" name="member_about" disabled><%=member_infoVO.getMember_about()%>
                             </textarea>
							</div>
						</div>
						<div class="col-12 row">
						...
						<div class="col-12">
							...
							<button id="submit-btn" type="submit"
								class="btn btn-primary col-4">修改資料</button>
						</div>
...
<script
	src="<%=request.getContextPath()%>/front-end/datetimepicker/jquery.js"></script>
<script
