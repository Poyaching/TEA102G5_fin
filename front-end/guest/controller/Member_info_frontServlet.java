...
@WebServlet("/guest/guestMember_info_frontServlet")
...
//				}
//				if (!errorMsgs.isEmpty()) {
//					RequestDispatcher failureView = req.getRequestDispatcher("/front-end/member_info/testpage.jsp");
//					failureView.forward(req, res);
//					return;// 程式中斷
//				}
//
...
//				/*************************** 2.開始查詢資料 *****************************************/
//				Member_infoService member_infoSvc = new Member_infoService();
//				Member_infoVO member_infoVO = member_infoSvc.getIdTest(member_email);
//				if (member_infoVO == null) {
//					errorMsgs.add("查無資料");
//				}
//				// Send the use back to the form, if there were errors
...
//				/*************************** 3.查詢完成,準備轉交(Send the Success view) *************/
//				req.setAttribute("member_infoVO", member_infoVO); // 資料庫取出的empVO物件,存入req
//				String url = "/front-end/member_info/testseccess.jsp";
//				RequestDispatcher successView = req.getRequestDispatcher(url); // 成功轉交 listOneEmp.jsp
//				successView.forward(req, res);
//
//				/*************************** 其他可能的錯誤處理 *************************************/
